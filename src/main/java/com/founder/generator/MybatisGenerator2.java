...
public class MybatisGenerator2 {
	...
	public static void main(String[] args) throws Exception {
		...
		//MYSQL
		//MybatisGenerator mg = new MybatisGenerator("com.ssmdemo", "f:\\code", "sm_t_","studentManage");
		//ORACLE
		/*MybatisGenerator2 mg = new MybatisGenerator2("com.yhkg.common", "COMM_T_",null);
		mg.setWorkspacePath("G:\\idea_project\\");
		mg.setModelPath("yhkg-common-web\\src\\main\\java\\com\\yhkg\\common\\model\\");
		mg.setServicePath("yhkg-common-web\\src\\main\\java\\com\\yhkg\\common\\service\\");
		mg.setServiceImplPath("yhkg-common-web\\src\\main\\java\\com\\yhkg\\common\\service\\impl\\");
		mg.setSqlMapperPath("yhkg-common-web\\src\\main\\resources\\mybatis\\");
		mg.setControllerPath("yhkg-common-web\\src\\main\\java\\com\\yhkg\\common\\controller\\");
		*/
//		MybatisGenerator2 mg = new MybatisGenerator2("com.ctsec.smt", "smt_","smt");
//		mg.setAuthor("yuyongjun");
//		mg.setWorkspacePath("G:\\idea_smt\\smt-parent");
//		mg.setModelPath("smt-facade\\src\\main\\java\\com\\ctsec\\smt\\model\\");
//		mg.setServicePath("smt-facade\\src\\main\\java\\com\\ctsec\\smt\\service\\");
//		mg.setServiceImplPath("smt-service\\src\\main\\java\\com\\ctsec\\smt\\service\\impl\\");
//		mg.setSqlMapperPath("smt-service\\src\\main\\resources\\mybatis\\");
//		mg.setControllerPath("smt-admin\\src\\main\\java\\com\\ctsec\\smt\\admin\\controller\\");

		MybatisGenerator2 mg = new MybatisGenerator2("com.szzd.collateral", "sys_","collateral");
		mg.setAuthor("yuyongjun");
		mg.setWorkspacePath("G:\\IDEA\\idea_project_szzd\\collateral-parent");
		mg.setModelPath("collateral-facade\\src\\main\\java\\com\\szzd\\collateral\\facade\\model\\");
		mg.setServicePath("collateral-facade\\src\\main\\java\\com\\szzd\\collateral\\facade\\service\\");
		mg.setServiceImplPath("collateral-service\\src\\main\\java\\com\\szzd\\collateral\\service\\impl\\");
		mg.setSqlMapperPath("collateral-service\\src\\main\\resources\\mybatis\\");
		mg.setControllerPath("collateral-web\\src\\main\\java\\com\\szzd\\collateral\\web\\controller\\");
...
/*		MybatisGenerator2 mg = new MybatisGenerator2("com.jsjc.ei", "BD_T_",null);
		...
		String[] tables = new String[]{"sys_business_relation"};
	...
	public MybatisGenerator2(String packagePrefix, String tablePrefix, String dbName) {
	...
	public void generatorSpringMVCController(String tableName, boolean writeable) throws Exception {
		...
		text.append("	@ApiOperation(value=\"XXX列表\", notes=\"XXX列表\")\n");
		...
		text.append("    })\n");
		text.append("	@GetMapping(value = \"/XXXList\", produces = \"application/json;charset=UTF-8\")\n");
		text.append("	@ResponseBody\n");
...
//		text.append("	}\n\n");
		...
		text.append("	@ApiOperation(value=\"获取XXX详细信息\", notes=\"根据url的id来获取XXX详细信息\")\n");
		...
		text.append("        @ApiResponse(code = CommonStatus.EXCEPTION, message = \"服务器内部异常\"),\n");
		text.append("   })\n");
		text.append("	@GetMapping(value = \"/XXXInfo/{id}\", produces = \"application/json;charset=UTF-8\")\n");
		text.append("	@ResponseBody\n");
		text.append("	public String detail(@PathVariable(value = \"id\") String id){\n");
		text.append("		try {\n");
		text.append("			"+modelName+" model = "+lowerServiceName+".selectById(id);\n");
		text.append("			BaseVO vo = new BaseVO();\n");
		...
		text.append("			logger.error(e.getMessage(), e);\n");
		text.append("		}\n");
		text.append("		return JSONObject.toJSONString(dataResponse, SerializerFeature.WriteMapNullValue);\n");
		text.append("	}\n\n");
