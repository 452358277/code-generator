...
public class MybatisGenerator {
	...
	public static void main(String[] args) throws Exception {
		...
		*/
		MybatisGenerator mg = new MybatisGenerator("com.founder.rew", "REW_",null);
...
/*		MybatisGenerator2 mg = new MybatisGenerator2("com.jsjc.ei", "BD_T_",null);
		...
		String[] tables = new String[]{"REW_WARNING_OBJECT"};
	...
	public MybatisGenerator(String packagePrefix, String tablePrefix, String dbName) {
